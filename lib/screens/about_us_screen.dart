...
class AboutUsScreen extends StatelessWidget {
  ...
  final String aboutUsHtml = '''
    ...
    <ul>
        ...
        <li>Protection of privacy — your saved articles never leave your phone</li>
    ...
    <h2>The Team</h2>
    <p>Led by Founder & Editor-in-Chief Anzer Ayoob, supported by a passionate team of reporters, video journalists, translators, and tech enthusiasts who work from the ground — because real stories don’t come from newsrooms, they come from the streets.</p>
